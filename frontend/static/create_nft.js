async function createNFT() {
    ...
    if (typeof window.ethereum !== 'undefined') {
        ...
        const contractAddress = '0x1C20d43FCB2a534Bf7608DeC1373ab74116dEB63'; // Replace with your contract address
        ...
        try {
            ...
            const tx = await contract.methods.mintNFT(
                address,
                JSON.stringify({ units: units, destination: destination, drugType: drugType })
            ).send({ from: address });
